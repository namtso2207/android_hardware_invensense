...
//ACCEL ICM45600
#define ACCEL_ICM45600_RANGE             (2.f * GRAVITY_EARTH)
#define ACCEL_ICM45600_RESOLUTION        (2.f * GRAVITY_EARTH / 32768.f)
#define ACCEL_ICM45600_POWER             (0.35f)
#define ACCEL_ICM45600_MINDELAY          (5000)
#define ACCEL_ICM45600_MINDELAY_HIFI     (1250)
...
//GYRO ICM45600
#define GYRO_ICM45600_RANGE              (2000.f * M_PI / 180.f)
#define GYRO_ICM45600_RESOLUTION         (2000.f * M_PI / (180.f * 32768.f))
#define GYRO_ICM45600_POWER              (0.75f)
#define GYRO_ICM45600_MINDELAY           (5000)
#define GYRO_ICM45600_MINDELAY_HIFI      (1250)
...
#define PRESSURE_BMP280_MINDELAY        (20000)    // 50Hz unit in ns
#define PRESSURE_BMP280_MAXDELAY        (80000)  // driver decimate to 12.5hz for CTS
/******************************************/
//LIGHT APDS9930
